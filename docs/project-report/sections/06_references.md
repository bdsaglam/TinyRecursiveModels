...
<!--
CITATION GUIDE:
Use [slug] format in text, e.g., "as shown by [trm]" or "[chollet2019]"
...
**[transformer]** Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, Ł., & Polosukhin, I. (2017). Attention Is All You Need. *Advances in Neural Information Processing Systems 30 (NeurIPS 2017)*.
