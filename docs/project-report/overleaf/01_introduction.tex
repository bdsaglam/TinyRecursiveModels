...
We present ETRM (Encoder-based TRM), an architecture that replaces TRM's puzzle\_id lookup with a neural encoder that processes demonstration pairs. Our main contributions are:
